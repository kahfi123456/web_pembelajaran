<h2 style="margin-bottom: 20px;">Yth. Admin UT,</h2>
...
<table style="margin-top: 20px; border-collapse: collapse;">
    ...
    <tr>
        <td style="padding: 4px 10px;"><strong>Email</strong></td>
        <td style="padding: 4px 10px;">: {{ $laporan['email'] }}</td>
    </tr>
    <tr>
        <td style="padding: 4px 10px;"><strong>Pesan</strong></td>
        <td style="padding: 4px 10px;">: {{ $laporan['pesan'] }}</td>
    </tr>
</table>
